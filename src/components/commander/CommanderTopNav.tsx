      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between gap-4">
          ...
          >
            ...
            <div>
              ...
              <p className={`text-[11px] hidden sm:block ${isDark ? 'text-slate-400' : 'text-slate-500'}`}>
                Supervisory Docket Review & Station Governance
              </p>
            </div>
          </button>
        </div>
        ...
        <div className="flex items-center gap-2 sm:gap-3">
          ...
          <div className="relative" ref={notifRef}>
            <button
              type="button"
              id="btn-commander-notifications"
            ...
            {isNotifOpen && (
              <div 
                id="commander-notifications-popover"
              ...
              >
                <div className={`p-3.5 px-4 border-b flex items-center justify-between ${
                  ...
                  <div className="flex items-center gap-2">
                    <span className="text-xs font-bold">Command Alerts</span>
                    {unreadCount > 0 && (
                ...
                <div className={`max-h-80 overflow-y-auto divide-y ${isDark ? 'divide-white/10' : 'divide-black/10'}`}>
                  {notifications.length === 0 ? (
                    <div className="p-8 text-center text-xs space-y-1.5">
                      ...
                      <p className="font-semibold">No operational alerts</p>
                      <p className={`text-[11px] ${isDark ? 'text-slate-400' : 'text-slate-500'}`}>
                        Inspection deadlines and citizen escalations will appear here.
                      </p>
                    </div>
                  ) : (
          ...
          >
            ...
            <div className="text-left">
              ...
              <p className="text-[10px] text-blue-600 font-mono">
                {user.rank || 'Commander'} • {user.personnelNumber}
              </p>
            </div>
          </button>
          ...
          <button
            ...
            title="Sign Out of Station Command"
          >
            <LogOut size={14} />
            <span>Sign Out</span>
          </button>
