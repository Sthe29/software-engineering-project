          ...
          >
            ...
            <div>
              ...
              <p className={`text-[11px] hidden sm:block ${isDark ? 'text-slate-400' : 'text-slate-500'}`}>
                CID Investigation & Docket Custody Desk
              </p>
            </div>
          </button>
        </div>
            ...
            {isNotifOpen && (
              ...
              >
                <div className={`p-3.5 px-4 border-b flex items-center justify-between ${
                  ...
                  <div className="flex items-center gap-2">
                    <span className="text-xs font-bold">Investigation Notices</span>
                    {unreadCount > 0 && (
                  ...
                  {notifications.length === 0 ? (
                    <div className="p-8 text-center text-xs space-y-1.5">
                      ...
                      <p className={`text-[11px] ${isDark ? 'text-slate-400' : 'text-slate-500'}`}>
                        Case assignments and directives will appear here.
                      </p>
                    </div>
                  ) : (
          ...
          >
            ...
            <div className="text-left">
              ...
              <p className="text-[10px] text-blue-600 font-mono">
                {user.rank || 'Detective'} • {user.personnelNumber}
              </p>
            </div>
          </button>
